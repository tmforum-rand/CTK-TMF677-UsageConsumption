...
var statusCode;
const exampleEndPoint = "/usageConsumptionReport";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF677 UsageConsumption R18 5\n");
getURL();
...
function exportEnvironment(url){
    ...
    envJson.values.forEach(element => {
        if (element.key == "UsageConsumptionAPI"){
            element.value = url;
        }
    });
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF677-UsageConsumption-R18-5.postman_collection.json'),
